...
<nav class="pcoded-navbar">
	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
				...
				<div class="user-details">
					<span id="more-details"><%= request.getSession().getAttribute("usuario")%><!-- pegando usuário da sessão --><i class="fa fa-caret-down"></i></span>
				</div>
			</div>
			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details">
					        <!--  <a href="user-profile.html"> <i class="ti-user"></i>View Profile</a> <a href="#!"><i -->
		...
		<ul class="pcoded-item pcoded-left-item">
			<li class="active">
			<a href="<%=request.getContextPath()%>/principal/principal.jsp" class="waves-effect waves-dark" style="margin-top: 8px;"> 
